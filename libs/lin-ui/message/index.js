...
Component({
  ...
  properties: {
    ...
    image: String,
    content: String,
    type: { type: String, value: 'primary', options: ['primary', 'warning', 'success', 'error'] },
    duration: { type: Number, value: 1500 },
    openApi: { type: Boolean, value: !0 },
    top: { type: Number, value: 0 },
  },
  data: { status: !1 },
  observers: { icon: function () {} },
  attached() {
    this.initMessage();
  },
  pageLifetimes: {
    ...
    initMessage() {
      (wx.lin = wx.lin || {}),
        (wx.lin.showMessage = (t = {}) => {
          ...
          return (
            (this.data.success = n),
            this.setData({ content: e, icon: i, image: a, duration: o, type: s, top: r }),
            this.changeStatus(),
            this
          );
        }),
