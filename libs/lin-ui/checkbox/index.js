Component({
  ...
  relations: { '../checkbox-group/index': { type: 'parent' } },
  options: { multipleSlots: !0 },
  properties: {
    placement: { type: String, value: 'left' },
    custom: { type: Boolean, value: !1 },
    key: { type: String, value: '' },
    cell: { type: Object, value: {} },
    size: { type: String, value: '38rpx' },
    disabled: { type: Boolean, value: !1 },
    selectColor: { type: String, value: '#3963BC' },
    disabledColor: { type: String, value: '#ccc' },
    color: { type: String, value: '#ccc' },
    checked: { type: Boolean, value: !1 },
  },
  data: { parentPlacement: '' },
  ready() {
    const e = this.getRelationNodes('../checkbox-group/index')[0];
    let { placement: t } = e.properties;
    this.setData({ parentPlacement: t });
  },
  methods: {
    onCheckboxChangeTap() {
